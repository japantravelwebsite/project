...
urlpatterns = [
    ...
    path("Chubu/Nagoya", views.GetNagoya, name = 'Nagoya'),
    path("Chubu/Nagoya_mov", views.GetNagoya_mov, name = 'Nagoya_mov'), # l
    ...
    path("Chubu/Shirakawago_mov", views.GetShirakawago_mov, name = 'Shirakawago_mov'),
    path("Chubu/Toyama_mov", views.GetToyama_mov, name = 'Toyama_mov'), # 
    path("Chubu/Gero_mov", views.GetGero_mov, name = 'Gero_mov'), # 
